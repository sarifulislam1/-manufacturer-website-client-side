...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-primary text-base-content rounded mt-8">
            ...
            <div>
                <p className='text-white'>Copyright © 2022 - All right reserved by PH-TOOLS</p>
            </div>
        </footer>
    );
};
