    ...
    return (
        <div className="card lg:card-side bg-base-100 shadow-xl m-9 mt-8">
            ...
            <div className="card-body text-center">
                <h2 className="text-2xl font-bold text-primary text-center">PH-Tools is the leading name in the field of manufacturing and trading of painting equipment.</h2>
                <p className='text-secondary'>Established in the year 2002, at Shahdara, New Delhi, India, we “PH-Tools” are one of the leading names in the field of manufacturing and trading of Paint rollers as well as other allied painting equipment.
