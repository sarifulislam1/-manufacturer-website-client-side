...
const Banner = () => {
    return (
        <div className="card lg:card-side bg-primary shadow-xl m-9 mt-8">
            ...
            <div className="card-body text-center">
                ...
                <p className='text-white text-left'>Established in the year 2002, at Shahdara, New Delhi, India, we “PH-Tools” are one of the leading names in the field of manufacturing and trading of Paint rollers as well as other allied painting equipment.
